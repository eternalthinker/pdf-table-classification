...
from local_word2vec.load_table_set import get_dataset
from local_word2vec.word2vec_utils import generate_batch, get_mean_context_embeds


def get_word2vec(fnames, indices):
    out = codecs.getwriter('utf-8')(sys.stdout)

    vocabulary_size = None
    data, count, dictionary, reverse_dictionary, vocabulary_size = get_dataset(vocabulary_size, fnames, indices)
    ...
    with tf.Session(graph=graph) as session:
        ...
        np.save("CBOW_Embeddings_subset", final_embeddings)
